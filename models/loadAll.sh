...
# Spawning All Models
rosrun gazebo_ros spawn_model -file ~/etc/LeHuyVinh/models/final.sdf -sdf -model final_setup -y -0.0 -x -0.0 -z 0.0
rosrun gazebo_ros spawn_model -file ~/etc/LeHuyVinh/models/final_test.sdf -sdf -model final_setup_test -y -0.0 -x -0.0 -z 0.0
sleep 2
